/*
    ...
    2) Include the keyword (to be set below) in the name of the page, e.g. 'Kampf' 
    which means battle in German ;)
    # How To Use
...
var updateStanceOnDrop = function (obj) {
    ...
    // this is the string that should be in any of your battle-pages, separated by spaces
    var keyword = 'Kampf';
    if (aContainsB(pagename,keyword)) {
        var isbattle = 1;
    };
    if (!obj.get('represents').length || isbattle !== 1) {
        return;
    }
